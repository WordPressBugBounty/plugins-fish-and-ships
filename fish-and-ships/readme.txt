...
= 2.1.8 - 25/03/2026 =
* Checked for WC 10.6.1
* Fixed rare bug on legacy support for old WAPF selectors
...
* Selector by product improved with predictive search box (pro)
* Fixed rare bug in some checkout updates (re-select first method)
